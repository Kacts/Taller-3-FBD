...
client = MongoClient("mongodb://ISIS2304H32202610:IAeFJw2NKaXC@157.253.236.88:8087")
...
def post_comentario(bar_id: int, datos: dict = Body(default={})):
    datos['bar_id'] = bar_id
...
def post_evento(bar_id: int, datos: dict = Body(default={})):
    datos['bar_id'] = bar_id
